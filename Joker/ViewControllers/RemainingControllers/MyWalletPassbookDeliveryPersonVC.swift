//
//  MyWalletPassbookDeliveryPersonVC.swift
//  Joker
//
...
class MyWalletPassbookDeliveryPersonVC: UIViewController {
    ...
    var deliveryWalletDataArr = NSArray()
    ...
    override func viewWillAppear(_ animated: Bool) {
        super.viewWillAppear(true)
         ...
         let param = ["userType":"DeliveryPerson","userId":UserDefaults.standard.value(forKey: "UserID") as? String ?? ""]
        
        self.apiCallForGetWalletDataOfDeliveryUser(param: param)
    }
...
//        self.navigationController?.pushViewController(vc, animated: true)
    ...
    func updateElement(dataDict:NSDictionary){
        ...
        if orderCount < 2{
            ...
            lblTotalOrders.text = "\(orderCount) Order"
        }
        else{
            
            lblTotalOrders.text = "\(orderCount) Orders"
        }
...
extension MyWalletPassbookDeliveryPersonVC:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return deliveryWalletDataArr.count
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let dict = deliveryWalletDataArr.object(at: indexPath.row) as? NSDictionary ?? [:]
...
//MARK:-
extension MyWalletPassbookDeliveryPersonVC:FilterMonthOrYearDelegate{
    
    func filterByMonthOrYear(Type: String, value: String) {
        
        let parameter = ["userType":"DeliveryPerson","userId":UserDefaults.standard.value(forKey: "UserID") as? String ?? "","\(Type)":value]
        
        self.apiCallForGetWalletDataOfDeliveryUser(param: parameter)
    }
...
//MARK:- Webservices
//MARK:-
extension MyWalletPassbookDeliveryPersonVC{
    
    func apiCallForGetWalletDataOfDeliveryUser(param:[String:String]){
            ...
            self.connection.startConnectionWithSting(App.URLs.apiCallForGetWalletPassbookInvoiceDetail as NSString, method_type: methodType.post, params: param as [NSString : NSObject]) { (receivedData) in
                ...
                if self.connection.responseCode == 1{
                    ...
                    if status == "SUCCESS"{
                        ...
                        self.deliveryWalletDataArr = invoiceArr
