...
class SubmitOfferAsDeliveryVC: UIViewController {
...
extension SubmitOfferAsDeliveryVC:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.viewTrackUsingForDelivery.isHidden = false
        cell.viewTrackUsingForProfessional.isHidden = true
...
extension SubmitOfferAsDeliveryVC{
